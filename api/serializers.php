...
function mapAgendamentoRow(array $row, array $notes, array $photos): array
{
    return [
        ...
        'property' => [
            ...
            'price' => $row['price'] !== null ? (float) $row['price'] : null,
            'source' => (string) $row['source'],
            'agencyId' => $row['agency_id'] !== null ? (int) $row['agency_id'] : null,
            'agencyName' => $row['agency_name'] !== null ? (string) $row['agency_name'] : null,
            'agencyMatchMode' => (string) $row['agency_match_mode'],
            'location' => $row['location'] !== null ? (string) $row['location'] : null,
